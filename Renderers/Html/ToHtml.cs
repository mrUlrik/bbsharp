...
/// <summary>
///     A delegate that allows you to register for your own BBCode tags. This is called when the parser encounters the
///     respective custom tag
/// </summary>
/// <param name="Node">The node that is the custom tag</param>
/// <param name="ThrowOnError">
///     True if an exception should be thrown upon error. If set to false, no exceptions should be
///     thrown and errors should be silently dealt with
/// </param>
...
{
    /// <summary>
    ///     The default lookup table. Contains renderers for [b], [i], [u], [code], [del], [ins], [hr], [body], [img] and [a]
    ///     tags
    /// </summary>
    public static LookupT[] DefaultLookupTable { get; } = new Dictionary<string, HtmlRendererCallback>
    {
    ...
    /// </summary>
    /// <param name="ThrowOnError">
    ///     Whether or to throw an exception when an error is encountered. If false, errors will be
    ///     silently ignored
    /// </param>
    /// <returns>The HTML source as a string</returns>
    public static string ToHtml(this IEnumerable<BBCodeNode> Nodes, bool ThrowOnError)
    {
        return Nodes.ToHtml(ThrowOnError, DefaultLookupTable);
    }
    ...
    ///     A KeyValuePair&lt;string,HtmlRendererCallback&gt;[] containing valid BBCode tags and their
    ///     HTML renderers
    /// </param>
    /// <returns>The HTML source as a string</returns>
    ...
    {
        return Node.ToHtml(ThrowOnError, DefaultLookupTable);
    }
